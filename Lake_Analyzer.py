...
class Lake_Analyzer:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            ...
            'Lake_Analyzer_{}.qm'.format(locale))
        ...
        self.actions     = []
        self.menu        = self.tr(u'&Lake_Analyzer')
    ...
    def tr(self, message):
        return QCoreApplication.translate('Lake_Analyzer', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            ...
            text=self.tr(u'Lake Analyzer — Water Quality'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr(u'&Lake_Analyzer'), action)
    ...
    def _show_help(self):
        ...
        QDesktopServices.openUrl(
            QUrl("https://github.com/iliasmachairas/Lakes_Analyzer#readme"))
    ...
    def _run_analysis(self):
        ...
        QgsMessageLog.logMessage(
            f"Run started — {date_str} | {aoi_bounds_msg}", "Lake_Analyzer")
    ...
    def _on_finished(self, result: dict):
        ...
        if aoi_warning:
            ...
            QgsMessageLog.logMessage(aoi_warning, "Lake_Analyzer", Qgis.MessageLevel.Warning)
    ...
    def _on_error(self, error_msg: str):
        ...
        QgsMessageLog.logMessage(error_msg, "Lake_Analyzer", Qgis.MessageLevel.Critical)
